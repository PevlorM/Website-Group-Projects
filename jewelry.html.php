...
<html lang="en">
	...
	<div class="wrapper">
		...
		<div class="top_nav">
			<div class="left">
			  <div class="imgLogo"><img src="images/nguvu.jpg" alt="Nguvu Logo" height="100" width="100"></div>
		  </div> 
		  <div class="right">
			<ul>
				...
				<div class="grid-container">
					<div class="grid-wrapper">
						<div class="grid-wrapper">
							...
							<img class="itemImg" id="$countedID" src = "$itemImage" height=100 alt ="Picture of item">
						</div>
					</div>
				</div>
                <br>
